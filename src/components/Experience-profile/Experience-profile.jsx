        ...
        <div className='experience__frontend'>
          ...
          <div className="experience__content">
            <article className='experience__details'>
              ...
              <div>
                <h2>worked on Docusign Integration(offer letter create for your orgnaisation.)</h2>
                <h4> <FaRegHandPointRight /> send Document to employee , employee signed the document.</h4>
                <h4> <FaRegHandPointRight /> After signed the document , it goes to manager</h4>
                <h4> <FaRegHandPointRight /> After manager signed the Document , it goes to CEO</h4>
                <h4> <FaRegHandPointRight />After CEO signed the document, the signed document send to all their mail id.</h4>
                <h4> <FaRegHandPointRight /></h4>
              </div>
            </article>
            <article className='experience__details'>
              <FaRegHandPointRight className='experience__details-icon' />
              <div>
                <h2>worked on MS Teams Integration(feedback,goal,review,recognition,goals notification on Bot APP of our organisation && user response the feedback through teams also.)</h2>
            ...
            <article className='experience__details'>
              <FaRegHandPointRight className='experience__details-icon' />
              <div>
                <h2>worked on Slack Integration(feedback,goal,review,recognition,goals notification on Bot APP of our organisation && user response the feedback through slack also.)</h2>
                <h4> <FaRegHandPointRight /> Real-time communication through channels, direct messages, and group chats.</h4>
                <h4> <FaRegHandPointRight /> Facilitates collaboration and file sharing</h4>
                <h4> <FaRegHandPointRight /> Organizes conversations into channels for better focus and easy retrieval</h4>
                <h4> <FaRegHandPointRight /> Customizable notifications and alerts.</h4>
